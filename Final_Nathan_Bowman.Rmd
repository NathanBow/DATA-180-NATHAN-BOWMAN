...
```
40/40. Good job Nathan. This is very well done. 
...
```{r}
loan_default_data_set<-read.csv("C:/Users/rodge/OneDrive/Desktop/DATA 180 -Intoduction to Data Science/DATA-180-Introduction-to-Data-Science--Section-2/data/loan_default_data_set.csv")
```
1.	Data wrangling:
...
#You fit a supervised learning model because you have a dependent and independent variables. 
