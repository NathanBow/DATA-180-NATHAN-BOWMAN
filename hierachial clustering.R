Cluster_Ex<-read.csv("/Users/Nathan/Desktop/DATA-180-NATHAN-BOWMAN/Cluster_Exnew.csv") #"Path where your data is goes here"
ls(Cluster_Ex)
head(Cluster_Ex)
...
Cluster_Ex<-read.csv("/Users/Nathan/Desktop/DATA-180-NATHAN-BOWMAN/Cluster_Exnew.csv")
