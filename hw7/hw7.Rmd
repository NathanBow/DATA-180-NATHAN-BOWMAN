...
```{r}
posWords <- scan("/Users/Nathan/Desktop/DATA-180-NATHAN-BOWMAN/hw7/positive-words.txt", character(0), sep = "\n")  # 2006 items
negWords <- scan("/Users/Nathan/Desktop/DATA-180-NATHAN-BOWMAN/hw7/negative-words.txt", character(0), sep = "\n")  # 4783 items
head(posWords,15)
head(negWords,15)
```
